...
public class instanciaConfiguracion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar / Editar instancia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(instanciaConfiguracion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
